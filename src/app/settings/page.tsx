...
const SETTINGS_TABS_BY_LOCALE: Record<AppLocale, SettingsTabDescriptor[]> = {
  en: [
    ...
    { id: "tasks", label: "Workflows", description: "Automations Hada runs on a schedule", icon: TasksIcon },
  ...
  ko: [
    ...
    { id: "tasks", label: "워크플로우", description: "Hada가 일정에 따라 실행하는 자동화", icon: TasksIcon },
  ...
  ja: [
    ...
    { id: "tasks", label: "ワークフロー", description: "Hada がスケジュール実行する自動化", icon: TasksIcon },
  ...
  zh: [
    ...
    { id: "tasks", label: "工作流", description: "Hada 按计划运行的自动化", icon: TasksIcon },
