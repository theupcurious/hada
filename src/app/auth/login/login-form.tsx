...
> = {
  ...
  zh: {
    verifySentToEmail: (email) => `我们已将验证链接发送到 ${email}。`,
    verifySentGeneric: "我们已将验证链接发送到你的邮箱。",
    signInFailed: "登录失败。",
    confirmEmailToContinue: "请先完成邮箱验证再继续。",
    enterEmailForResend: "请输入邮箱以重新发送验证链接。",
    sentNewVerificationToEmail: (email) => `我们已将新的验证链接发送到 ${email}。`,
    enterEmailBeforeReset: "请先输入邮箱地址，再点击“忘记密码”。",
    resetSendFailed: "无法发送重置邮件。请检查网络连接后重试。",
    title: "欢迎回来",
    subtitle: "登录后继续使用 Hada",
    emailVerifiedTitle: "邮箱已验证！",
    emailVerifiedBody: "你的邮箱地址已确认，现在可以登录开始使用。",
    verifyBannerTitle: "请验证邮箱以完成注册",
    verifyBannerFallback: "请检查收件箱中的验证链接。",
    ...
    forgotPassword: "忘记密码？",
    resetSentPrefix: "请检查收件箱，我们已将密码重置链接发送到",
    signIn: "登录",
    signingIn: "登录中...",
