...
> = {
  ...
  zh: {
    title: "记忆",
    subtitle: "查看并管理 Hada 在跨会话中保留的事实与偏好。",
    howMemoryWorks: "记忆如何工作",
    memorySeparateFromChat: "记忆与聊天历史分开保存。",
    memoryExplanationOne: "记忆是 Hada 可以在未来对话中重复使用的长期事实或偏好。",
    memoryExplanationTwo: "清除聊天历史不会删除已保存的记忆。",
    savedMemories: "已保存的记忆",
    savedMemoriesDescription: "搜索、编辑、添加或删除已保存的记忆条目。",
    addMemory: "添加记忆",
    cancel: "取消",
    searchMemories: "搜索记忆",
    topic: "主题",
    ...
    noMemoriesYet: "还没有保存任何记忆。",
    noMemoriesMatchSearch: "没有匹配搜索条件的记忆。",
    updated: "更新于",
    edit: "编辑",
    delete: "删除",
    topicAndContentRequired: "主题和内容都是必填项。",
    memorySaved: "记忆已保存。",
    memoryUpdated: "记忆已更新。",
    memoryDeleted: "记忆已删除。",
