...
> = {
  en: {
    ...
    googleErrorMessages: {
      ...
      encryption_not_configured: "Server is missing its token encryption key. Contact the administrator.",
  ...
  ko: {
    ...
    googleErrorMessages: {
      ...
      encryption_not_configured: "서버에 토큰 암호화 키가 설정되어 있지 않습니다. 관리자에게 문의하세요.",
  ...
  ja: {
    ...
    googleErrorMessages: {
      ...
      encryption_not_configured: "サーバーにトークン暗号化キーが設定されていません。管理者に連絡してください。",
  ...
  zh: {
    ...
    waitingForConfirmation: "等待链接确认中...",
    confirmGoogleDisconnect: "确定要断开你的 Google 账户吗？",
    googleConnected: "Google 账户连接成功。",
    googleDisconnected: "Google 账户已断开。",
    googleConnectFailed: "连接 Google 账户失败。",
    googleDisconnectFailed: "断开 Google 账户失败。",
    telegramLinkFailed: "创建 Telegram 链接失败。",
    telegramLinkCreated: "Telegram 链接已生成。打开后发送 /start 完成绑定。",
    googleErrorMessages: {
      google_oauth_denied: "你拒绝了对 Google 账户的访问授权。",
      invalid_oauth_response: "Google 返回了无效的 OAuth 响应。",
      invalid_state: "state 参数无效。请重试。",
      not_authenticated: "你必须先登录才能连接集成。",
      token_exchange_failed: "交换授权码失败。",
      no_refresh_token: "未能从 Google 获取 refresh token。",
      encryption_not_configured: "服务器未配置令牌加密密钥，请联系管理员。",
      database_error: "保存集成信息失败。请重试。",
